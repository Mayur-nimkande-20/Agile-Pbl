...
<?php require "assets/pages/Modal.php" ?> 

<p style="margin: 20px 5px 20px 320px ; color:#393E46; font-size: 30px;"><b>Wallet Details:</b> </p>

<div id="walletblock" class="inline-block">
  <p style="font-size: 25px">Name: <?php echo $name ?> </p>
  <p style="font-size: 25px">Mobile: <?php echo $mob ?> </p>
</div>
...
<div id="menu_bar" class="d-flex justify-content-between col-7 m-auto mt-3">
  ...
  <button type="button" onclick="window.location.href='assets/pages/report.php'" class="btn btn-primary" style="margin-left:50px">
   Get Report
  </button>

  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModalCenter" style="margin-left:500px; margin-right:20px">
    Add Money
  </button>
